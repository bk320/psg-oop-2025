...
- Los clientes pueden unirse a un sala virtual
- Los clientes ven la pelicula juntos
- Los clientes pueden unirse a una sala virtual existente
- Los clientes pueden ver cuantas persona estan en la sala
- Los clientes pueden ver el titulo de la pelicula en la sala
- Los clientes tiene un nombre para registrase
- Los clientes pueden saber el estado y tiltulo de la pelicula
- Las peliculas tiene un titulo
- Las peliculas tiene un estado de reproduccion (bolean)
- La sala puede iniciar y finalizar una pelicula dando el titulo
